            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="border p-3">
                        ...
                        <form action="{{ route('balls.create') }}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="ballName">Ball Name:</label>
                                <input type="text" class="form-control" id="ballName" name="name"
                                    placeholder="Ball Name">
                            </div>
                            <div class="mb-3">
                                <label for="ballSize">Ball Size:</label>
                                <input type="number" class="form-control" id="ballSize" name="size"
                ...
                <div class="col-md-6 mb-3">
                    <div class="border p-3">
                        ...
                        <form action="{{ route('buckets.create') }}" method="post">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="bucketCapacity" name="capacity"
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <form action="{{ route('balls.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="ballId">Select Ball:</label>
                            <select class="form-select" id="ballId" name="ball_id">
                                @foreach ($balls as $ball)
                                    <option value="{{ $ball->id }}">{{ $ball->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary">Place Balls</button>
                    </form>
                    </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="border p-3">
                            ...
                            <div class="border p-3">
                                <h4 class="mb-3">List of Buckets</h4>
                                <ul class="list-group">
                                    @foreach($buckets as $bucket)
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            {{ $bucket->name }}
                                            <span class="badge bg-primary rounded-pill">{{ $bucket->capacity }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
